                ...
                <div>
                    <div class="box-body">
                        <div class="form-group" style="display: none;">
                            <input class="form-control" type="text" id="id_person" value="<?php echo $id;?>">
                        </div>
                        ...
                        <div class="form-group">
                            <button class="btn btn-success" id="btn-editpu-guardar" onclick="savep()"> Editar Persona</button>
                        </div>
                    </div>
                    <!-- /.box-body -->
